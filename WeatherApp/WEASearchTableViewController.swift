...
class WEASearchTableViewController: UITableViewController, UISearchControllerDelegate, UISearchBarDelegate {
    ...
    override func viewDidLoad() {
        ...
        var searchController: UISearchController = UISearchController(searchResultsController: self );
        searchController.delegate = self;
...
//        searchController.searchBar.layer.borderWidth = 1.0
        searchController.searchBar.tintColor = UIColor.wea_colorWithHexString("#2f91ff")
        searchController.searchBar.barTintColor = UIColor.wea_colorWithHexString("#2f91ff")
